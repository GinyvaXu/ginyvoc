...
// 复制代码（排除 .git / release / temp / node_modules）
const EXCLUDE = new Set(['.git', 'release', 'temp', 'node_modules', 'build', 'installer', 'versions', 'dist', 'logs']);
...
`;
writeFileSync(join(outDir, 'README-Debug.txt'), readme, 'utf8');
