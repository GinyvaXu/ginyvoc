...
![形态](https://img.shields.io/badge/形态-Web%20%2B%20Electron-blue) ![平台](https://img.shields.io/badge/平台-Windows%20%2F%20macOS%20%2F%20Linux-lightgrey) ![版本](https://img.shields.io/badge/版本-v0.4.0-green) ![技术](https://img.shields.io/badge/技术-WebRTC%20%2B%20Node.js-orange)
...
| 🖥️ 屏幕共享 | 共享整屏 / 窗口 / 标签页，多人可同时共享 |
| 💬 文字聊天 | 房间内文字聊天，方便发房号、协调 |
| 🔗 邀请链接 | 一键复制 `http://host:3000/?room=XXXXXX` |
| ⚙️ 完整设置 | 输入设备、VAD 灵敏度、降噪/回声消除、自定义 PTT 按键 |
